      ...
      <div className="stay-content">
        ...
        <div className="main-accommodation">
          <div className="accommodation-details">
            ...
            <p>PLEASE LET US KNOW IF YOU WOULD LIKE TO STAY THE NIGHT OF OUR WEDDING BY EMAILING <a href="mailto:WEDDINGADAMSTEPH@GMAIL.COM" className="email-link">WEDDINGADAMSTEPH@GMAIL.COM</a></p>
            <p>B&B RATES ARE €97.50 PPS WHEN TWO GUESTS SHARE A TWIN OR DOUBLE ROOM.</p>
            <p>THERE ARE FAMILY ROOMS AND SINGLE OCCUPANCY ALSO AVAILABLE.</p>
            <p>CHECK-IN IS FROM 2PM. BREAKFAST IS 8.30AM UNTIL 10.30AM. CHECK-OUT IS 11AM IN THE PAVILION.</p>
          </div>
        </div>
