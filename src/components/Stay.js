...
const Stay = () => {
  const accommodations = [
    ...
    { name: 'CLARE STREET B&B', drive: '11 MINUTE DRIVE', phone: '+353 67 43627', website: 'BANDBIRELAND.COM',  link: 'https://www.bandbireland.com/accommodation/28170/clare-street-b-b' },
